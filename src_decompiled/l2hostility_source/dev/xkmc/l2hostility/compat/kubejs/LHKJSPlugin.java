...
public class LHKJSPlugin implements KubeJSPlugin {
   private static final ResourceKey<Registry<MobTrait>> TRAITS = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath("l2hostility", "trait"));
   ...
   public void registerBuilderTypes(BuilderTypeRegistry registry) {
      ...
      registry.of(Registries.ITEM, reg -> reg.add("trait", TraitItemBuilder.class, TraitItemBuilder::new));
   }
   ...
   private static MobTrait parseMobTrait(RegistryAccessContainer ctx, Object o) {
      ...
      if (id == null) {
         throw new IllegalStateException("Cannot parse " + o + " into MobTrait");
      } else {
         return (MobTrait)LHTraits.TRAITS.reg().get(id);
      }
   }
}
