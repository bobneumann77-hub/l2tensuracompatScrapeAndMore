...
public class TraitSpawnerBlock {
   ...
   public static final BlockEntityBlockMethodImpl<BurstSpawnerBlockEntity> BE_BURST = new BlockEntityBlockMethodImpl(
      LHBlocks.BE_BURST, BurstSpawnerBlockEntity.class
   );
