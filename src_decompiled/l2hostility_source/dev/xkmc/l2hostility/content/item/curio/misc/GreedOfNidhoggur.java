...
public class GreedOfNidhoggur extends CurseCurioItem {
   ...
   public int getExtraLevel() {
      return (Integer)LHConfig.SERVER.nidhoggurExtraLevel.get();
   }

   @Override
   public double getLootFactor(ItemStack stack, PlayerDifficulty player, MobTraitCap mob) {
      return (Double)LHConfig.SERVER.greedDropFactor.get();
   }

   public void appendHoverText(ItemStack stack, TooltipContext level, List<Component> list, TooltipFlag flag) {
      String nid = LangData.perc((Double)LHConfig.SERVER.nidhoggurDropFactor.get());
