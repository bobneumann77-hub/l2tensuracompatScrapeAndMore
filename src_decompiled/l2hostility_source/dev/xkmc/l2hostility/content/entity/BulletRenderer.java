...
public class BulletRenderer extends ShulkerBulletRenderer {
   ...
   public BulletRenderer(Context p_174368_) {
      super(p_174368_);
   ...
   public ResourceLocation getTextureLocation(ShulkerBullet bullet) {
      return bullet instanceof HostilityBullet b && b.type == BulletType.EXPLODE ? TEXTURE_LOCATION : super.getTextureLocation(bullet);
   }
}
