...
public class LHDamageTypes extends DamageTypeAndTagsGen {
   ...
   public LHDamageTypes() {
      ...
      new DamageTypeHolder(this, KILLER_AURA, new DamageType("killer_aura", DamageScaling.NEVER, 0.1F))
         .add(new TagKey[]{DamageTypeTags.BYPASSES_ARMOR, DamageTypes.IS_MAGIC});
      new DamageTypeHolder(this, REFLECT, new DamageType("indirectMagic", DamageScaling.NEVER, 0.0F))
         .add(new TagKey[]{DamageTypeTags.BYPASSES_ARMOR, DamageTypes.IS_MAGIC});
   }
