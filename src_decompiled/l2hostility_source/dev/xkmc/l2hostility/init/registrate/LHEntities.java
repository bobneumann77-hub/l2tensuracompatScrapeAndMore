...
public class LHEntities {
   public static final EntityEntry<HostilityBullet> BULLET = L2Hostility.REGISTRATE
      .entity("hostility_bullet", HostilityBullet::new, MobCategory.MISC)
      .properties(e -> e.sized(0.3125F, 0.3125F).clientTrackingRange(8))
      .renderer(() -> BulletRenderer::new)
      .register();
   public static final EntityEntry<HostilityCharge> CHARGE = L2Hostility.REGISTRATE
      .entity("hostility_charge", HostilityCharge::new, MobCategory.MISC)
      .properties(e -> e.sized(1.0F, 1.0F).clientTrackingRange(4).updateInterval(10))
      .renderer(() -> LHEntities::addRenderer)
      .defaultLang()
      .register();

   @OnlyIn(Dist.CLIENT)
   private static <T extends Entity & ItemSupplier & ISizedItemEntity> EntityRenderer<T> addRenderer(Context ctx) {
