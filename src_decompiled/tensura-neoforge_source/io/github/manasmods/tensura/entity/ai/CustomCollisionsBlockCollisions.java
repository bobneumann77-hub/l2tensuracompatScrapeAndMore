package io.github.manasmods.tensura.entity.ai;
         ...
         if (l != 3) {
            ...
            if (blockgetter != null) {
               ...
               if ((!this.onlySuffocatingBlocks || blockstate.isSuffocating(blockgetter, this.pos))
                  ...
                  if (!(
                     this.context instanceof EntityCollisionContext collisionContext
                        && collisionContext.getEntity() instanceof IDigging<?> digging
                        && digging.canPassThrough(this.pos, blockstate, voxelshape)
                  )) {
