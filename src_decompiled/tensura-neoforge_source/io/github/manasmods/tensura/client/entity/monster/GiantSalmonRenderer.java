...
public class GiantSalmonRenderer extends GeoEntityRenderer<GiantSalmonEntity> {
   public GiantSalmonRenderer(Context renderManager) {
      super(renderManager, new GiantSalmonModel());
   }

   protected float getShadowRadius(GiantCodEntity entity) {
      return entity.isBaby() ? 0.25F : 0.5F;
   }

   public void preRender(
      PoseStack poseStack,
      GiantSalmonEntity animatable,
      BakedGeoModel model,
