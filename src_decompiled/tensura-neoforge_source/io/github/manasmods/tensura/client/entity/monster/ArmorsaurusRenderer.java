...
public class ArmorsaurusRenderer extends GeoEntityRenderer<ArmorsaurusEntity> {
   public ArmorsaurusRenderer(Context renderManager) {
      super(renderManager, new ArmorsaurusModel());
   }

   protected float getShadowRadius(ArmorsaurusEntity entity) {
      return entity.isBaby() ? 0.5F : 1.0F;
   }

   public void preRender(
      PoseStack poseStack,
      ArmorsaurusEntity animatable,
      BakedGeoModel model,
