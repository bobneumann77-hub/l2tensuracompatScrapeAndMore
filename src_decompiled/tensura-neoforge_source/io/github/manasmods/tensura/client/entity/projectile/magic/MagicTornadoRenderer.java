...
public class MagicTornadoRenderer<T extends TensuraFlyingProjectile & GeoEntity> extends GeoEntityRenderer<T> {
   public MagicTornadoRenderer(Context renderManager) {
      super(renderManager, new MagicTornadoModel());
   }
