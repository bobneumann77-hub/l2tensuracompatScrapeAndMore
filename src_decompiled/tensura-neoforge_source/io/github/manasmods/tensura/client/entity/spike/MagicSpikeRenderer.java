...
public class MagicSpikeRenderer<T extends MagicSpikeEntity> extends GeoEntityRenderer<T> {
   public MagicSpikeRenderer(Context renderManager) {
      super(renderManager, new MagicSpikeModel());
   }
