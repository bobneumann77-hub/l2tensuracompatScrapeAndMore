...
public class MagicBallRenderer<T extends TensuraFlyingProjectile & GeoEntity> extends GeoEntityRenderer<T> {
   public MagicBallRenderer(Context renderManager) {
      super(renderManager, new MagicBallModel());
   }
