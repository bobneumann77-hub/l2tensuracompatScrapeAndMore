...
public class TempestSerpentRenderer extends GeoEntityRenderer<TempestSerpentEntity> {
   public TempestSerpentRenderer(Context renderManager) {
      super(renderManager, new TempestSerpentModel());
   }

   protected float getShadowRadius(TempestSerpentEntity entity) {
      return entity.isBaby() ? 0.25F : 0.5F;
   }

   public void preRender(
      PoseStack poseStack,
      TempestSerpentEntity animatable,
      BakedGeoModel model,
