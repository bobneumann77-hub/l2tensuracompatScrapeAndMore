...
public class CattledeerRenderer extends GeoEntityRenderer<CattledeerEntity> {
   public CattledeerRenderer(Context renderManager) {
      super(renderManager, new CattledeerModel());
   }

   protected float getShadowRadius(CattledeerEntity entity) {
      return entity.isBaby() ? 0.25F : 0.5F;
   }

   public void preRender(
      PoseStack poseStack,
      CattledeerEntity animatable,
      BakedGeoModel model,
