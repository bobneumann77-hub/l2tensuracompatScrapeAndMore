...
public class FaultFieldLayer<T extends Entity, M extends EntityModel<T>> extends MultiRenderLayer<T, M> {
   private static final ResourceLocation FAULT_FIELD_TEXTURE = ResourceLocation.fromNamespaceAndPath("tensura", "textures/models/layer/riptide.png");

   public FaultFieldLayer(RenderLayerParent<T, M> renderLayerParent) {
      super(renderLayerParent);
   }

   public <E extends Entity & GeoEntity> FaultFieldLayer(GeoRenderer<E> entityRenderer) {
      super(entityRenderer);
   }

   private RenderType getRenderType(float f) {
      return RenderType.energySwirl(FAULT_FIELD_TEXTURE, f * 0.02F % 1.0F, f * 0.01F % 1.0F);
   }
   ...
   public void render(
      ...
      if (entity instanceof LivingEntity living) {
         if (SpatialDominationSkill.hasFaultField(living)) {
