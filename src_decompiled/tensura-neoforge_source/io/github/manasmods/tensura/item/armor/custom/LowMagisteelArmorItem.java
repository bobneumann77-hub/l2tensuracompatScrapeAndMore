...
public class LowMagisteelArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public LowMagisteelArmorItem(Type type) {
      super(TensuraArmorMaterials.LOW_MAGISTEEL, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR), 35);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "low_magisteel"));
               }
