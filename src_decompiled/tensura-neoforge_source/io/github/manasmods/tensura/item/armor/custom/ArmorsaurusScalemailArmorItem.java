...
public class ArmorsaurusScalemailArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public ArmorsaurusScalemailArmorItem(Type type) {
      super(TensuraArmorMaterials.ARMORSAURUS_SCALEMAIL, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR), 38);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "armorsaurus_scalemail"));
               }
