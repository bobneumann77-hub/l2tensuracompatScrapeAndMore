...
public class KnightSpiderCarapaceArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public KnightSpiderCarapaceArmorItem(Type type) {
      super(TensuraArmorMaterials.KNIGHT_SPIDER_CARAPACE, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR), 37);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "knight_spider_carapace"));
               }
