...
public class ArmorsaurusArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public ArmorsaurusArmorItem(Type type) {
      super(TensuraArmorMaterials.ARMORSAURUS, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR), 40);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "armorsaurus"));
               }
