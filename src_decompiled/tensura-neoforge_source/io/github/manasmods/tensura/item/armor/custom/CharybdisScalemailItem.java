...
public class CharybdisScalemailItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public CharybdisScalemailItem(Type type) {
      super(TensuraArmorMaterials.CHARYBDIS_SCALEMAIL, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR).fireResistant(), 65);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "charybdis_scalemail"));
               }
