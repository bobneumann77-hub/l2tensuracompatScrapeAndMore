...
import io.github.manasmods.tensura.client.armor.PureMagisteelArmorRenderer;
...
public class PureMagisteelArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public PureMagisteelArmorItem(Type type) {
      super(TensuraArmorMaterials.PURE_MAGISTEEL, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR).fireResistant(), 60);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new PureMagisteelArmorRenderer();
               }
