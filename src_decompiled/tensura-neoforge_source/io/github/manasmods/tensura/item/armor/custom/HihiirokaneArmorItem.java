...
import io.github.manasmods.tensura.client.armor.HihiirokaneArmorRenderer;
...
public class HihiirokaneArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public HihiirokaneArmorItem(Type type) {
      super(TensuraArmorMaterials.HIHIIROKANE, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR).fireResistant(), 80);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new HihiirokaneArmorRenderer();
               }
