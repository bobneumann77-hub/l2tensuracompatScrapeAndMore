...
import io.github.manasmods.tensura.client.armor.OrichalcumArmorRenderer;
...
public class OrichalcumArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public OrichalcumArmorItem(Type type) {
      super(TensuraArmorMaterials.ORICHALCUM, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR).fireResistant(), 50);
   }
