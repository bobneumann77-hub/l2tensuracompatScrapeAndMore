...
public class AntCarapaceArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public AntCarapaceArmorItem(Type type) {
      super(TensuraArmorMaterials.ANT_CARAPACE, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR), 34);
   }
         ...
         new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(
               ...
               if (this.renderer == null) {
                  this.renderer = new DefaultArmorRenderer(ResourceLocation.fromNamespaceAndPath("tensura", "ant_carapace"));
               }
