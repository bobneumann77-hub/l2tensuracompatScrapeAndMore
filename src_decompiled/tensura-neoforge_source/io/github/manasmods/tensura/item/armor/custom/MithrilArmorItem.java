...
import io.github.manasmods.tensura.client.armor.MithrilArmorRenderer;
...
public class MithrilArmorItem extends SimpleArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

   public MithrilArmorItem(Type type) {
      super(TensuraArmorMaterials.MITHRIL, type, new Properties().arch$tab(TensuraCreativeTabs.ARMOR).fireResistant(), 45);
   }
