...
public class UnicornHornItem extends ArrowItem {
   public UnicornHornItem(Properties pProperties) {
      super(pProperties);
   ...
   public AbstractArrow createArrow(Level level, ItemStack itemStack, LivingEntity livingEntity, @Nullable ItemStack itemStack2) {
      return new UnicornHornProjectile(level, livingEntity, itemStack.copyWithCount(1), itemStack2);
   }

   public Projectile asProjectile(Level level, Position position, ItemStack itemStack, Direction direction) {
      UnicornHornProjectile arrow = new UnicornHornProjectile(level, position.x(), position.y(), position.z(), itemStack.copyWithCount(1), (ItemStack)null);
