...
public class SimpleOdachiItem extends TwoHandedSwordItem {
   ...
   public SimpleOdachiItem(Tier pTier, Properties properties) {
      super(pTier, 6, -3.2F, 2.0, 0.5, 20.0, 0.0, (int)(-1.0F - pTier.getAttackDamageBonus()), -4.0F, 2.0, 0.0, 0.0, 0.0, properties);
   }
