...
public class TensuraBoatItem extends Item {
   ...
   public TensuraBoatItem(Properties properties, TensuraBoatEntity.Type typeIn) {
      super(properties);
      this.type = typeIn;
      DispenserBlock.registerBehavior(this, new TensuraBoatDispenseItemBehavior(TensuraBoatEntity.Type.PALM));
   }
   ...
   public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
      ...
      if (rayTraceResult.getType() == Type.BLOCK) {
         TensuraBoatEntity boatEntity = new TensuraBoatEntity(
