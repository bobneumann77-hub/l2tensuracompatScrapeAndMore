...
public class ElectroBlastMagic extends SpiritualMagic {
   public static final SpiritualMagicConfig.ElectroBlast CONFIG = ((SpiritualMagicConfig)ConfigRegistry.getConfig(SpiritualMagicConfig.class)).ElectroBlast;

   public ElectroBlastMagic() {
   ...
   public boolean onHeld(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int mode) {
      ...
      if (heldTicks >= castTime) {
         ...
         BeamProjectile.spawnLastingBeam(
            (EntityType<? extends BeamProjectile>)MiscEntityTypes.ELECTRO_BLAST.get(),
            CONFIG.damage,
            1.0F,
            21,
            CONFIG.range,
