...
public class EarthWallMagic extends AspectualMagic {
   private static final AspectualMagicConfig.EarthWall CONFIG = ((AspectualMagicConfig)ConfigRegistry.getConfig(AspectualMagicConfig.class)).EarthWall;

   public EarthWallMagic() {
   ...
   public String getModeId(ManasSkillInstance instance, int mode) {
      return switch (mode) {
         case 0 -> "earth_wall.5x5x1";
         case 1 -> "earth_wall.5x5x2";
         case 2 -> "earth_wall.5x5x3";
         case 3 -> "earth_wall.10x10x1";
   ...
   public void onRelease(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int keyNumber, int mode) {
      if (heldTicks >= this.getCastingTime(instance, entity)) {
         if (!EnergyHelper.isOutOfEnergy(entity, instance, mode)) {
            ...
            this.placeWall(instance, entity, entity.level(), result, mode);
         }
      }
   }

   private void placeWall(ManasSkillInstance instance, LivingEntity entity, Level level, BlockHitResult result, int mode) {
