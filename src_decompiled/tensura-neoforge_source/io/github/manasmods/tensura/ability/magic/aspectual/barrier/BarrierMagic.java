...
public class BarrierMagic extends AspectualMagic {
   private static final AspectualMagicConfig.Barrier CONFIG = ((AspectualMagicConfig)ConfigRegistry.getConfig(AspectualMagicConfig.class)).Barrier;
   ...
   public void onRelease(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int keyNumber, int mode) {
      if (heldTicks >= this.getCastingTime(instance, entity)) {
         if (entity.hasEffect(TensuraMobEffects.getReference(TensuraMobEffects.PHYSICAL_BARRIER))) {
            ...
            MobEffectInstance barrier = new MobEffectInstance(
               TensuraMobEffects.getReference(TensuraMobEffects.PHYSICAL_BARRIER),
