...
public class AgilityMagic extends AspectualMagic {
   private static final AspectualMagicConfig.Agility CONFIG = ((AspectualMagicConfig)ConfigRegistry.getConfig(AspectualMagicConfig.class)).Agility;
            ...
            if (target != null && entity.isShiftKeyDown()) {
               ...
               target.addEffect(
                  new MobEffectInstance(
                     ...
                     instance.isMastered(entity) ? CONFIG.hasteDurationMastered : CONFIG.hasteDuration,
                     CONFIG.hasteLevel - 1,
                     true,
                     false,
                     true
               ...
               MobEffectInstance haste = new MobEffectInstance(
                  MobEffects.DIG_SPEED,
                  instance.isMastered(entity) ? CONFIG.hasteDurationMastered : CONFIG.hasteDuration,
                  CONFIG.hasteLevel - 1,
                  true,
               ...
               TensuraMobEffect.addEffect(entity, haste, entity, this);
               entity.level()
                  .playSound(
                     null,
                     entity.getX(),
