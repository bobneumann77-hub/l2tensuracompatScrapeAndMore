...
public class AntiShockAreaMagic extends AspectualMagic {
   public static final AspectualMagicConfig.AntiShockArea CONFIG = ((AspectualMagicConfig)ConfigRegistry.getConfig(AspectualMagicConfig.class)).AntiShockArea;

   public AntiShockAreaMagic() {
   ...
   public void onPressed(ManasSkillInstance instance, LivingEntity entity, int keyNumber, int mode) {
      if (entity.isShiftKeyDown()) {
         ...
         AntiShockAreaEntity barrier = ObjectSelectionHelper.getTargetingEntity(AntiShockAreaEntity.class, entity, distance, 0.5, false, false, false);
         if (barrier != null) {
   ...
   public void onRelease(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int keyNumber, int mode) {
      if (!entity.isShiftKeyDown()) {
         if (heldTicks >= this.getCastingTime(instance, entity)) {
            AntiShockAreaEntity barrier = new AntiShockAreaEntity(entity.level(), entity);
            barrier.setLife(instance.isMastered(entity) ? CONFIG.durationMastered : CONFIG.duration);
