...
public class FlameBreathSkill extends Skill {
   private static final IntrinsicSkillConfig.FlameBreath CONFIG = ((IntrinsicSkillConfig)ConfigRegistry.getConfig(IntrinsicSkillConfig.class)).FlameBreath;

   public FlameBreathSkill() {
