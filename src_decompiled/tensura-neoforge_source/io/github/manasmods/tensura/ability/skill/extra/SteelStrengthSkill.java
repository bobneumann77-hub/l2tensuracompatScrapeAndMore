...
public class SteelStrengthSkill extends Skill {
   private static final ExtraSkillConfig.SteelStrength CONFIG = ((ExtraSkillConfig)ConfigRegistry.getConfig(ExtraSkillConfig.class)).SteelStrength;

   public SteelStrengthSkill() {
   ...
   public void onToggleOff(ManasSkillInstance instance, LivingEntity entity) {
      ...
      if (effect != null && effect.getAmplifier() <= CONFIG.strengthenLevel - 1) {
         entity.removeEffect(TensuraMobEffects.getReference(TensuraMobEffects.STRENGTHEN));
      }
   }
}
