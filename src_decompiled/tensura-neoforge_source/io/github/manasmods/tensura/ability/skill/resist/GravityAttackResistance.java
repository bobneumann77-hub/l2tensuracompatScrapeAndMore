...
public class GravityAttackResistance extends ResistSkill {
   @Override
   ...
   public List<Holder<MobEffect>> getImmuneEffects(ManasSkillInstance instance, LivingEntity entity) {
      return List.of(MobEffects.LEVITATION);
   }

   @Nullable
   @Override
   protected ManasSkill getNullificationForm() {
      return (ManasSkill)ResistanceSkills.GRAVITY_ATTACK_NULLIFICATION.get();
   }
}
