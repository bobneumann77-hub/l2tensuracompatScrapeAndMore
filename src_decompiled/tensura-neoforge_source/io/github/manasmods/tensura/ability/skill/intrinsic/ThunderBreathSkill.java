...
public class ThunderBreathSkill extends Skill {
   private static final IntrinsicSkillConfig.ThunderBreath CONFIG = ((IntrinsicSkillConfig)ConfigRegistry.getConfig(IntrinsicSkillConfig.class)).ThunderBreath;
   ...
   public boolean onHeld(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int mode) {
      ...
      if (heldTicks % 2 == 0) {
         entity.level()
            .playSound(
               null, entity.getX(), entity.getY(), entity.getZ(), (SoundEvent)TensuraSoundEvents.BREATH_THUNDER.get(), TensuraSkill.ABILITY_SOUND, 0.75F, 1.0F
            );
      }

      float damage = instance.isMastered(entity) ? CONFIG.damageMastered : CONFIG.damage;
      BreathEntity.spawnBreathEntity((EntityType<? extends BreathEntity>)MiscEntityTypes.THUNDER_BREATH.get(), entity, instance, damage, this, mode);
      return true;
   }
}
