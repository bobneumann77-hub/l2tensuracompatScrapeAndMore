...
public class CorrosionNullification extends ResistSkill {
   public CorrosionNullification() {
   ...
   public List<Holder<MobEffect>> getImmuneEffects(ManasSkillInstance instance, LivingEntity entity) {
      return List.of(TensuraMobEffects.getReference(TensuraMobEffects.CORROSION), MobEffects.WITHER);
   }
}
