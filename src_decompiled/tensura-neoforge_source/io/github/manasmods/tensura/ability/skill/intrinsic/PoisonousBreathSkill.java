...
public class PoisonousBreathSkill extends Skill {
   public static final IntrinsicSkillConfig.PoisonousBreath CONFIG = ((IntrinsicSkillConfig)ConfigRegistry.getConfig(IntrinsicSkillConfig.class)).PoisonousBreath;
   ...
   public boolean onHeld(ManasSkillInstance instance, LivingEntity entity, int heldTicks, int mode) {
      ...
      BreathEntity.spawnBreathEntity((EntityType<? extends BreathEntity>)MiscEntityTypes.POISONOUS_BREATH.get(), entity, instance, damage, this, mode);
      return true;
   }
}
