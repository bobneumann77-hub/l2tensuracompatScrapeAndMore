...
public class RoyalBeastSkill extends Skill implements ITransformation {
   private static final UniqueSkillConfig.RoyalBeast CONFIG = ((UniqueSkillConfig)ConfigRegistry.getConfig(UniqueSkillConfig.class)).RoyalBeast;
