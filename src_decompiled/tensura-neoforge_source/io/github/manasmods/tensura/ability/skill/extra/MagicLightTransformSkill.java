...
public class MagicLightTransformSkill extends MagicElementalTransformSkill {
   @Override
   ...
   protected ManasSkill getElementalTransform() {
      return (ManasSkill)IntrinsicSkills.LIGHT_TRANSFORM.get();
   }
   ...
   protected void doVisualEffect(LivingEntity entity) {
      TensuraParticleHelper.spawnServerParticles(
         entity.level(),
         TensuraParticleUtils.getYellowGust(),
         entity.getX(),
