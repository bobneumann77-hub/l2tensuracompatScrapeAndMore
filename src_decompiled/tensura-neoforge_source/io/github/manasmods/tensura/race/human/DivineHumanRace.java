...
public class DivineHumanRace extends HumanSaintRace {
   public DivineHumanRace(Difficulty difficulty) {
      super(difficulty);
   }

   public DivineHumanRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((HumanConfig)ConfigRegistry.getConfig(HumanConfig.class)).DivineHuman;
   }
   ...
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((HumanConfig)ConfigRegistry.getConfig(HumanConfig.class)).DivineHuman.epRequirement), 100.0F);
   }
