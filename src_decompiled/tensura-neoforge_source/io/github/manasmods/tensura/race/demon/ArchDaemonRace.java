...
public class ArchDaemonRace extends GreaterDaemonRace {
   public ArchDaemonRace(Difficulty difficulty) {
      super(difficulty);
   }

   public ArchDaemonRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((DaemonConfig)ConfigRegistry.getConfig(DaemonConfig.class)).ArchDaemon;
   }

   @Override
   public ManasRace getDefaultEvolution(ManasRaceInstance instance, LivingEntity entity) {
      return (ManasRace)TensuraRaces.DAEMON_LORD.get();
   }
   ...
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((DaemonConfig)ConfigRegistry.getConfig(DaemonConfig.class)).ArchDaemon.epRequirement), 100.0F);
   }
