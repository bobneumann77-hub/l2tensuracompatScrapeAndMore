...
public class DwarfSaintRace extends EnlightenedDwarfRace {
   public DwarfSaintRace(Difficulty difficulty) {
      super(difficulty);
   }

   public DwarfSaintRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((DwarfConfig)ConfigRegistry.getConfig(DwarfConfig.class)).DwarfSaint;
   }
   ...
   public ManasRace getDefaultEvolution(ManasRaceInstance instance, LivingEntity entity) {
      return (ManasRace)TensuraRaces.DIVINE_DWARF.get();
   }
   ...
   public List<ManasRace> getNextEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.DIVINE_DWARF.get());
   }
   ...
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      DwarfConfig.DwarfSaint config = ((DwarfConfig)ConfigRegistry.getConfig(DwarfConfig.class)).DwarfSaint;
      return Map.of(
