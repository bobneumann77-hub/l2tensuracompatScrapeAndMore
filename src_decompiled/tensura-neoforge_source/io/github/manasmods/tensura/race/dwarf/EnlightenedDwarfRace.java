...
public class EnlightenedDwarfRace extends DwarfRace {
   public EnlightenedDwarfRace(Difficulty difficulty) {
      super(difficulty);
   }

   public EnlightenedDwarfRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((DwarfConfig)ConfigRegistry.getConfig(DwarfConfig.class)).EnlightenedDwarf;
   }
   ...
   public List<ManasRace> getPreviousEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.DWARF.get());
   }

   @Override
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((DwarfConfig)ConfigRegistry.getConfig(DwarfConfig.class)).EnlightenedDwarf.epRequirement), 100.0F);
   }
}
