...
public class SpiritBeastRace extends BeastLordRace {
   public SpiritBeastRace(Difficulty difficulty) {
      super(difficulty);
   }

   public SpiritBeastRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((BeastfolkConfig)ConfigRegistry.getConfig(BeastfolkConfig.class)).SpiritBeast;
   }
   ...
   public ManasRace getDefaultEvolution(ManasRaceInstance instance, LivingEntity entity) {
      return (ManasRace)TensuraRaces.DIVINE_BEAST.get();
   }
   ...
   public List<ManasRace> getNextEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.DIVINE_BEAST.get());
   }
   ...
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      BeastfolkConfig.SpiritBeast config = ((BeastfolkConfig)ConfigRegistry.getConfig(BeastfolkConfig.class)).SpiritBeast;
      return Map.of(
