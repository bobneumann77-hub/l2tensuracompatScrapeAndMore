...
public class SpiritSkeletonRace extends WightKingRace {
   public SpiritSkeletonRace(Difficulty difficulty) {
      super(difficulty);
   }

   public SpiritSkeletonRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((WightConfig)ConfigRegistry.getConfig(WightConfig.class)).SpiritSkeleton;
   }

   @Override
   public ManasRace getDefaultEvolution(ManasRaceInstance instance, LivingEntity entity) {
      return (ManasRace)TensuraRaces.DIVINE_SKELETON.get();
   }
   ...
   public List<ManasRace> getNextEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.DIVINE_SKELETON.get());
   }

   @Override
   public List<ManasRace> getPreviousEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.WIGHT_KING.get());
   }

   @Override
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((WightConfig)ConfigRegistry.getConfig(WightConfig.class)).SpiritSkeleton.epRequirement), 100.0F);
   }

   @Override
   public List<ManasSkill> getIntrinsicSkills(ManasRaceInstance instance, LivingEntity entity) {
      List<ManasSkill> list = super.getIntrinsicSkills(instance, entity);
      list.add((ManasSkill)SpiritualMagics.CURSE.get());
      return list;
   }
