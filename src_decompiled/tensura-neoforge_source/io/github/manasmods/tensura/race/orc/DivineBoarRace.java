...
public class DivineBoarRace extends SpiritBoarRace {
   public DivineBoarRace(Difficulty difficulty) {
      super(difficulty);
   }

   public DivineBoarRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((OrcConfig)ConfigRegistry.getConfig(OrcConfig.class)).DivineBoar;
   }
   ...
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((OrcConfig)ConfigRegistry.getConfig(OrcConfig.class)).DivineBoar.epRequirement), 100.0F);
   }
