...
public class SpiritOniRace extends MysticOniRace {
   public SpiritOniRace(Difficulty difficulty) {
      super(difficulty);
   }

   public SpiritOniRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((OgreConfig)ConfigRegistry.getConfig(OgreConfig.class)).SpiritOni;
   }
   ...
   public List<ManasRace> getPreviousEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.MYSTIC_ONI.get());
   }

   @Override
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((OgreConfig)ConfigRegistry.getConfig(OgreConfig.class)).SpiritOni.epRequirement), 100.0F);
   }
}
