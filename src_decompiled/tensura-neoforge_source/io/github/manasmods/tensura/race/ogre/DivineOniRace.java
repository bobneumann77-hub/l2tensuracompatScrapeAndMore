...
public class DivineOniRace extends SpiritOniRace {
   public DivineOniRace(Difficulty difficulty) {
      super(difficulty);
   }

   public DivineOniRace() {
   ...
   public RaceConfig.Default getDefaultConfig() {
      return ((OgreConfig)ConfigRegistry.getConfig(OgreConfig.class)).DivineOni;
   }
   ...
   public List<ManasRace> getPreviousEvolutions(ManasRaceInstance instance, LivingEntity entity) {
      return List.of((ManasRace)TensuraRaces.SPIRIT_ONI.get(), (ManasRace)TensuraRaces.DEATH_ONI.get());
   }

   @Override
   public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
      return Map.of(new EvolutionRequirement.EPRequirement(((OgreConfig)ConfigRegistry.getConfig(OgreConfig.class)).DivineOni.epRequirement), 100.0F);
   }
