...
public class SimpleEffectParticle extends TextureSheetParticle {
   ...
   SimpleEffectParticle(
      ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, SpriteSet spriteSet, SimpleEffectParticleOptions options
   ) {
   ...
   @OnlyIn(Dist.CLIENT)
   public static class Provider implements ParticleProvider<SimpleEffectParticleOptions> {
      ...
      public Particle createParticle(SimpleEffectParticleOptions options, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
         SimpleEffectParticle bubbleParticle = new SimpleEffectParticle(clientLevel, d, e, f, g, h, i, this.sprite, options);
