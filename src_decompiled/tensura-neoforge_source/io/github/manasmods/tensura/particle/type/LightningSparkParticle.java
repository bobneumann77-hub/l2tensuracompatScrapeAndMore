...
public class LightningSparkParticle extends TextureSheetParticle {
   ...
   LightningSparkParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, SpriteSet spriteSet) {
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
         LightningSparkParticle particle = new LightningSparkParticle(clientLevel, d, e, f, g, h, i, this.sprite);
